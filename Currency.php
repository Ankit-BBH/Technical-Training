        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <a href="/" class="d-flex align-items-center link-body-emphasis text-decoration-none">
                    <span class="fs-4">Currency Exchange</span>
                </a>
                ...
                <div class="row mb-3 text-center">
                    <div class="col">
                        ...
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Exchange</h4>
                        </div>
                            <div class="card-body">
                            <form action="currencyBackend.php" method="post">
                                <fieldset>
                                    <legend>Currency Exchange Rate</legend>
                                    <label for="amount">Amount : </label>
                                    <input type="number" name="amt" id="amt" min=1 required>
